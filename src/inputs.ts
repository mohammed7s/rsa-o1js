...
const STRING_PRESELECTOR = ""
const MAX_HEADER_PADDED_BYTES = 768 
const MAX_BODY_PADDED_BYTES = 6272
...
//console.log('circuit_inputs', JSON.stringify(circuitInputs)); 
console.log('in_padded', JSON.stringify(circuitInputs.in_padded)); 
